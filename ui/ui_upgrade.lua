...
function ui_upgrade:init()
  ...
  self.btn_start = ui.newButton(w-110, 100, 100, 40, "START", font_low)
    ...
    self.img_tank = {}
    self.img_tank.image = love.graphics.newImage("img/tank.png")
    self.img_tank.x = 100
    self.img_tank.y = 100
  ...
  self.img_turret = {}
  self.img_turret.image = love.graphics.newImage("img/turret.png")
  self.img_turret.sprite = {}
   self.img_turret.sprite[1] = love.graphics.newQuad(0, 0, 32, 32, self.img_turret.image:getDimensions())
  
  self.upgrade = {}
    self.upgrade[1] = love.graphics.newImage("img/ui/upgrade_1.png")
    self.upgrade[2] = love.graphics.newImage("img/ui/upgrade_2.png")
    self.upgrade[3] = love.graphics.newImage("img/ui/upgrade_3.png")
    self.upgrade[4] = love.graphics.newImage("img/ui/upgrade_4.png")
    self.upgrade[5] = love.graphics.newImage("img/ui/upgrade_5.png")
    self.upgrade[6] = love.graphics.newImage("img/ui/upgrade_6.png")
    self.upgrade[7] = love.graphics.newImage("img/ui/upgrade_7.png")
  ...
  self.tlbar_upgrade:setOutlineColor(0, 0, 0, 0)
    ...
    self.icn_shield = ui.newIcon(0, 0, "img/ui/shield.png", 5)
      self.icn_shield:setEvent("pressed", addShieldPoint)
    self.icn_speed = ui.newIcon(0, 0, "img/ui/engine.png", 5)
      self.icn_speed:setEvent("pressed", addSpeedPoint)
    self.icn_repair = ui.newIcon(0, 0, "img/ui/repair.png", 5)
    self.icn_damage = ui.newIcon(0, 0, "img/ui/engine.png", 5)
