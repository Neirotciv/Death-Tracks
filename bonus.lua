...
local bonus = {}
  ...
  bonus.ammoBox = {}
    bonus.ammoBox.image = love.graphics.newImage("img/ammo_box.png")
    bonus.ammoBox.total = 2
    
  bonus.dollar = {}
    bonus.dollar.image = love.graphics.newImage("img/dollar.png")
    
  bonus.repair = {}
    bonus.repair.image = love.graphics.newImage("img/repair.png")
