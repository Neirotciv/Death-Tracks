...
function ui_race:init()
  self.currentImage = 3
  self.countdownImage = {}
    self.countdownImage[1] = love.graphics.newImage("assets/img/ui/countdown_1.png")
    self.countdownImage[2] = love.graphics.newImage("assets/img/ui/countdown_2.png")
    self.countdownImage[3] = love.graphics.newImage("assets/img/ui/countdown_3.png")
  self.countdown = 3
...
function ui_race:draw()
  ...
  if self.countdownEnd == false then
    ...
    love.graphics.draw(self.countdownImage[self.currentImage], screenWidth/2, screenHeight/2, 0, 10, 10, 8, 8)
